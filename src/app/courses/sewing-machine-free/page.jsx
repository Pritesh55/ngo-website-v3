...
const FreeSewingMachineCoursePage = () => {
  return (
    <>
      {/* <!-- 1 ▸ HERO SECTION --------------------------------------------- --> */}
      <section className="relative flex items-center justify-center px-4 py-12 md:py-24 bg-linear-to-br from-emerald-50 to-teal-50 border-b border-emerald-100">
        <div className="relative z-10 max-w-6xl mx-auto text-center">
          
          {/* Tagline Badge */}
          <div className="mb-5 md:mb-6 inline-block">
            <div className="px-4 py-1.5 md:px-5 md:py-2 rounded-full border border-emerald-250 bg-emerald-100/50 backdrop-blur-xs">
              <p className="text-xs md:text-base font-semibold text-emerald-800 capitalize tracking-wider">
                100% Free • Women Empowerment & Skill Development Program
              </p>
            </div>
          </div>

          {/* Big Sponsorship Banner */}
          <div className="max-w-3xl mx-auto mb-8 p-5 md:p-6 bg-linear-to-r from-emerald-600 to-teal-700 text-white rounded-3xl shadow-lg border border-emerald-400/30 relative overflow-hidden">
            ...
            <p className="text-xs md:text-sm uppercase tracking-widest text-emerald-100 font-bold">Special Free Initiative</p>
            <h2 className="text-xl md:text-3xl font-black mt-1.5 tracking-tight">
              Sponsored by Saksham KVK 2.0
            </h2>
          </div>

          {/* Main Title */}
          <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold text-slate-900 mb-4 md:mb-6 leading-tight">
            <span className="bg-linear-to-r from-emerald-700 via-teal-600 to-indigo-900 bg-clip-text text-transparent">
              Free Sewing Machine Operator Course
            </span>
          </h1>

          {/* Subheadline */}
          <p className="text-base md:text-xl text-slate-700 mb-6 md:mb-8 max-w-3xl mx-auto leading-relaxed font-semibold">
            Change your future in just 3 months and become completely self-reliant at zero cost!
          </p>

          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mt-8">
            <Link
              href="https://wa.me/919974025126?text=I%20want%20to%20register%20for%20the%20Free%20Sewing%20Machine%20Course%20sponsored%20by%20Saksham%20KVK%202.0"
              target="_blank"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 items-stretch">
            ...
            <div className="lg:col-span-5 flex flex-col gap-6">
              ...
              {/* Highlight Metrics */}
              <div className="bg-linear-to-br from-emerald-50/80 to-teal-50/40 border-2 border-emerald-200 rounded-3xl p-5 md:p-6 shadow-xs space-y-5 md:space-y-6">
                
                <div className="flex items-start gap-3 md:gap-4">
                  <div className="p-2.5 md:p-3 bg-emerald-100 rounded-xl text-emerald-700 flex-shrink-0">
                ...
                <div className="flex items-start gap-3 md:gap-4 pt-5 border-t border-emerald-200/50">
                  <div className="p-2.5 md:p-3 bg-emerald-100 rounded-xl text-emerald-700 flex-shrink-0">
                    <Award className="w-5 h-5 md:w-6 md:h-6" />
                  </div>
                  <div>
                    <h3 className="text-xs md:text-sm font-bold capitalize tracking-wider text-slate-500 mb-1">Course Fee</h3>
                    <p className="text-lg md:text-xl font-bold text-emerald-700">FREE (100% Sponsored)</p>
                    <p className="text-xs md:text-sm text-slate-650 font-semibold mt-1">Fully Sponsored by Saksham KVK 2.0</p>
                  </div>
                </div>
              ...
              <div className="bg-white border border-slate-200 p-5 md:p-6 rounded-3xl shadow-xs">
                ...
                <p className="text-slate-650 text-sm md:text-base leading-relaxed font-semibold">
                  To enable women to secure respectable jobs or start their own home-based business by gaining technical skills in industrial machine operation and garment construction under the free Saksham KVK 2.0 initiative.
                </p>
              </div>
            ...
            <div className="lg:col-span-7 flex flex-col justify-between space-y-6">
              ...
              <div className="bg-white border border-slate-200 rounded-3xl p-5 md:p-8 shadow-xs flex-1">
                ...
                <div className="space-y-5 md:space-y-6">
                  ...
                  {/* Skill 3 */}
                  <div className="flex gap-3 md:gap-4 items-start pt-5 border-t border-slate-100">
                    <div className="p-2 md:p-2.5 bg-teal-100 text-teal-700 rounded-xl flex-shrink-0 mt-1">
      ...
      <section className="bg-glow-warm py-12 md:py-20 px-4 text-center relative overflow-hidden">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-base md:text-lg text-slate-700 max-w-2xl mx-auto mb-8 md:mb-10 leading-relaxed font-semibold">
            The free sponsored batch is starting soon. Contact us now to secure your registration under the Saksham KVK 2.0 program.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center items-center">
            ...
            >
              <img
                ...
                className="w-5 h-5 object-contain brightness-0 invert"
              />
              Join via WhatsApp (Apply Now)
            </a>
            <a
              href="tel:9974025126"
              className="group inline-flex items-center justify-center gap-3 w-full sm:w-auto px-6 py-3 md:px-8 md:py-4 bg-linear-to-r from-emerald-600 to-teal-700 text-white font-bold rounded-xl hover:shadow-lg hover:shadow-emerald-500/35 transition-all text-sm md:text-base capitalize tracking-wider cursor-pointer"
            >
              <Phone className="w-5 h-5" />
              Call to Register
            </a>
...
export default FreeSewingMachineCoursePage
