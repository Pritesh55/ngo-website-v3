    ...
    return (
        <>
            ...
            <div className="flex gap-x-8 lg:hidden">
                ...
                <Link href='/cart' className='bg-yellow-400 px-4 py-2 rounded-lg'>
                    <Image src={'/icons/cart-icon.svg'} width={28} height={28} className='w-7 h-7' alt='cart' ></Image>
                </Link>
            ...
            <PopoverGroup className="hidden lg:flex lg:gap-x-12">
                ...
                <Link href="/cart" className="text-lg font-semibold text-gray-900">
                    Cart
                </Link>
                ...
                <DialogPanel className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-3 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex sm:hidden">
                            <a href="#" className="px-8 py-1.5 rounded-lg bg_grad_moti">
                                <span className="text-xl sm:text-3xl tracking-wide font-semibold text-black ">Kashi</span>
                            </a>
                        </div>
                        ...
                        <button
                            ...
                            className="rounded-md text-gray-700 ml-auto"
                        >
