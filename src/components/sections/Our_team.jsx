...
const Our_team = () => {
    ...
    const Our_Team_Section_Header_info = {
        ...
        subTitle: t('teamSection.subTitle') || 'OUR TEAM',
        title: t('teamSection.title') || 'Meet Our Dedicated Team',
        description: t('teamSection.description') || 'Our enthusiastic and dedicated members who work tirelessly for positive social change.',
    }
    ...
    const teamList = allContent?.team || defaultTeam
